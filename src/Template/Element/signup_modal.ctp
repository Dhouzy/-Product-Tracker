            ...
            <div class="modal-body">
                <form id="form-signup">
                    <div class="input-group input-group-sm">
                        ...
                        <span id="username" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="email" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="password" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"><span class="fa fa-fw fa-user"></span></span>
                    ...
                    <div class="input-group input-group-sm">
                        ...
                        <span id="last_name" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="phone" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="street_number" class="input-group-addon validation validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"><span class="fa fa-fw fa-map-marker"></span></span>
                        <?= $this->Form->text('street', ['placeholder' => __('Global.Street'), 'class' => 'form-control']) ?>
                        <span id="street" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="city" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        ...
                        <span id="province" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
                    <div class="input-group input-group-sm">
                        <span class="input-group-addon"><span class="fa fa-fw fa-map"></span></span>
                        <?= $this->Form->text('country', ['placeholder' => __('Global.Country'), 'class' => 'form-control']) ?>
                        <span id="country" class="input-group-addon validation not-visible"><span class="fa fa-fw fa-asterisk"></span></span>
                    </div>
